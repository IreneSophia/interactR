...
#' @param col.plot Vector of characters. Three named characters containing Hex colour codes:
#'   one for observed values, one for pseudo and one for the highlights which is named
#'   "observed exceeding pseudo". Default is `blue`, `green` and `lightblue`.
#'
